...
class Aligner:
    ...
    def star(self) -> None:
        ...
        def create_dirs(*args: str, **kwargs: str) -> None:
            output_path = os.path.join(bam_directory,
        ...
        executor(
            ...
            input_function=lambda l: " ".join(sorted(l)),
            input_split_reads=False,
            output_format=f"{star_dir_format}/{output_format}"
            ".Aligned.out.sam",
            split_by_organism=True,
            only_human=self.only_human
        )
        ...
        counts_format = os.path.join(bam_directory,
                                     f"{output_format}_counts.txt")
        executor(
